...
apt-get update
apt-get install -y wget curl jq libfuse2 libglib2.0-0 autoconf automake cproto gettext libacl1-dev libgpm-dev libgtk-3-dev libtinfo-dev libxmu-dev libxpm-dev libncurses-dev libperl-dev liblua5.2-0 liblua5.2-dev libluajit-5.1-dev lua5.2 luajit python-dev python3-dev ruby-dev
